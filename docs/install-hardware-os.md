...
>
>Speaking of the external hard drive, right now it's a 2.5" SATA spinning disk salvaged from an old Dell laptop on its way to the recycler. (I plan to upgrade to an SSD... someday.) The [USB to SATA adapter is from Tripp-Lite](https://www.tripplite.com/USB-3-0-SuperSpeed-SATA-III-Adapter-Cable-UASP-2-5in-3-5in-SATA-White~U33806NSATAW), and honestly, I bought it because they had an option for a white colored model that looks really sharp when paired with the official Pi case. I found out later that it has [some features](https://en.wikipedia.org/wiki/USB_Attached_SCSI) that make improve its speed.
