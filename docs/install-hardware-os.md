...
## Summary of Commands
1. Using the Raspberry Pi Imager is shown in this [slideshow of screenshots](raspberry-pi-imager.md).
...
>### Serial Console
>A serial cable as an alternate way to log in can be helpful for troubleshooting. If you have the required cable, Adafruit has a good article on [how to set up the connection](https://learn.adafruit.com/adafruits-raspberry-pi-lesson-5-using-a-console-cable/enabling-serial-console). They'd be happy to sell you the cable as well.
