...
If all goes well, wait a bit and open a web browser for your Raspberry Pi on port 9000. (e.g. http://mypi.home:9000 or http://192.168.0.42:9000) You should see the Portainer logo and fields to set up administrative credentials. Set up your admin user and password and you'll be logged in.
